export const heightSet = (setHeight) => {
    ...
    let setHeightDiv = parseFloat(windowHeight) - (parseFloat(getHeight) + parseFloat(menuHeight) + 205)
...
export const rowBodyHeightSet = (setInnerHeight) => {
    ...
    let windowHeight = window.innerHeight
    let setHeightDiv = parseFloat(windowHeight) - (parseFloat(getHeight) + 205)
